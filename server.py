    ...
    def do_POST(self):
        ...
        try:
            ...
            if 'favorite-animal' in path:      
                ...
                json_object = json.dumps(body, indent=4, ensure_ascii=False).encode('utf-8').decode()
                ...
                #CHECK LATERRRRRRRRRRRRRRRRRRRRRRRRRR
                ...
                print(os.path.join(directory, latest_file))
